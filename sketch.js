...
function draw() {
  ...
  if(frameCount%80===0){
	  particles.push(new Particle(random(width/2-20, width/2+10),5,5));
  }

  if(frameCount%70===0){
	  particles.push(new Particle(random(180, 10),5,5));
  }

  if(frameCount%50===0){
	  particles.push(new Particle(random(420, 10),5,5));
  }
